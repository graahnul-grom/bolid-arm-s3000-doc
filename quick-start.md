...
Это настройки влияют как на работу самой системы **s3k**,
...
Убедиться, что на пульте установлена минимально допустимая версия прошивки
...
**s2km** (интерфейсы подключения RS-232 и RS-485) и
**s2km2** (два интерфейса RS-485)

- **s2km**         3.14 / 4.14 - diff HW platforms
- **s2km2** 5.02
...
рекомендуется руководствоваться сведениями из раздела
...
(описание см. в разделе "Загрузка конфигурации пульта в **s3k**" выше).
