...
- **Примечание:** так обозначены краткие аннотации к основному тексту.
<!--
...
Убедитесь, что на пульте установлена ... версия прошивки
и обновите ее, если необходимо, с помощью программы [UProg](https://bolid.ru/production/orion/po-orion/po-config/uprog.html):
`2ASK` Pprog?
...
- `ORIG` `BUG` Режим работы - "Компьютер"
  ...
  - пожар
  - etc...
  а  *Параметры второго порта связи -> Режим* (p.108)
  - ПРИНТЕР
  - КОМПЬЮТЕР
  - RS-485 РЕЗЕРВ
  - ПИ/РЕЗЕРВ
