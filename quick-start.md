...
- Нажать на странице свойств бота кнопку в правом верхнем углу,
  в появившемся меню выбрать пункт "Список пользователей".
- Нажать кнопку добавления нового пользователя
  и ввести "Пользовательское описание" (фактически - отображаемое имя).
- Открыв вновь список пользователей и отредактировав нужного,
  задать набор уведомлений, которые пользователь будет получать, -
