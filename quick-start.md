...
Настройка прибора осуществляется следующим образом:
...
<!-- TODO
UDP port forwarding
take from docker md files
-->

<!--
Также следует произвести настройку в web-интерфейсе **s3k**:
**Внимание:**
Совместимость - "Иные приборы"
-->
