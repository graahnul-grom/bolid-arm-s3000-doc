...
Эти настройки влияют как на работу самой системы,
...
[s3k-re 2.3.5.1 Режим конфигурации системы p80]()

<!--
TODO warn that after pressing "save..." you should wait until the page is reloaded
выход производится нажатием
Конфигурация может быть применена:
Таким образом,
[См. "Загрузка конфигурации пульта в **s3k**"]()
[См. "Применение загруженной конфигурации к пульту"]()
[См. "Применение загруженной конфигурации к линии без пульта"]()
-->
...
- Если соединение установлено успешно, в открывшемся окне "Авторизация на С3000-Hub"
  ...
  предварительно создан в web-интерфейсе **s3k**, см. "Добавление пользователей".
...
После этого станет доступной кнопка "Конфигурации".
...
- Добавить нового пользователя (кнопка слева сверху), после чего
  ...
  ([s3k-re 2.3.5.7.3 Настройка нового бота Telegram p144]()).
