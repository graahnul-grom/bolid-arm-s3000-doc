...
- Если соединение установлено успешно, в открывшемся окне "Авторизация на С3000-Hub"
  ...
  *`Конфигурирование структуры объекта`* → *`Пользователи`*.
  [s3kre: 2.3.5.2 Страница «Пользователи» p81]()
...
Применение конфигурации для линии без пульта аналогичны
приведенным выше с той лишь разницей, что применение действия
производятся на странице свойств линии.
