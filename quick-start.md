...
- Далее следуют два вопроса, на которые требуется ответить,
  задав отображаемое имя и имя пользователя для нового бота.
  Имя пользователя должно оканчиваться на "bot", например,
  "MyS3000bot".
