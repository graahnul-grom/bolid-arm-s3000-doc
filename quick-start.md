...
В секции "Тайминги" устанавливаются временны̀́́́́́́́́́́е параметры
для используемого порта. В большинстве случае достаточно
оставить значения по умолчанию, но для портов типа **s2k-eth**
следует руководствоваться разделами
"Требования и рекомендации по настройке временных параметров"
и "Настройка временных параметров" документации **s2k-eth**.
...
[s3k-re 2.3.5.3.1.1 Параметры линий p91]()<br />
[s3k-re 2.3.5.3.1.2 Добавление линии p96]()
