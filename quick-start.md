...
// После нажатия на кнопку "Сгенерировать" сертификат будет создан
// на странице "Установленный"

- **Внимание:**
В системе может использоваться лишь один сертификат. После нажатия
на кнопку "Сгенерировать" новый сертификат будет создан
и *заменит* собой установленный ранее.

В системе используется только один сертификат.
После нажатия на кнопку "Сгенерировать" сертификат будет создан
и *заменит* собой уже установленный в системе.
и *заменит* собой установленный ранее.
