...
к соответствующим раздела руководства по эксплуатации
  и другим документам
    При использовании интерфейсов RS-232 и RS-485
-->
...
С устройствами, имеющими интерфейсы RS-232 и RS-485,
чаще всего применяются преобразователи, например,
USB - для удобства подключения к компьютеру.
...
- protocol: ORION (w/o s2km), ORION PRO (with s2km)
